...
const util = module.exports = {
  ...
  // Create a filter function for limiting config module based on tags args.
  filterTags: (tags) => {
    tags = tags || [];

    // Create a lookup table of specified tags.
    const tagsMap = tags.reduce((acc, tag) => Object.assign(acc, { [tag]: true }), {});

    return (obj) => !tags.length || obj.tags.some((tag) => tagsMap[tag]);
  },
